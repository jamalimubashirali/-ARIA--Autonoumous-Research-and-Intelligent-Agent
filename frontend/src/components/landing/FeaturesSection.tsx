    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
          ...
          <div
            data-feat-card
            className="md:col-span-2 min-h-[340px] relative overflow-hidden rounded-3xl bg-zinc-950 ring-1 ring-white/10 p-6 hover-lift group border-gradient"
          >
            <div className="relative z-10">
              <span className="text-xs text-zinc-500 uppercase tracking-widest font-medium">
                Research Pipeline
              </span>
              <h3 className="text-2xl text-zinc-100 font-medium mt-2 tracking-tight">
            ...
            <div className="absolute bottom-6 right-6 w-[320px] rounded-xl bg-zinc-900/80 ring-1 ring-white/5 overflow-hidden opacity-90">
              ...
              <div className="p-3 font-mono text-[11px] leading-relaxed">
                <div className="anim-cycle-1">
                  ...
                  <span className="text-blue-300">gather_sources</span>
                  <span className="text-zinc-400">(query):</span>
                </div>
                <div className="anim-cycle-2">
                  <span className="text-zinc-400"> </span>
                  <span className="text-cyan-300">web_results</span>
                  <span className="text-zinc-400"> = </span>
                  <span className="text-yellow-300">await</span>
                  <span className="text-zinc-400"> crawl(query)</span>
                </div>
                ...
                <div className="anim-cycle-3">
                  ...
                  <span className="text-emerald-300">verified_report</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div
            data-feat-card
            className="min-h-[340px] relative overflow-hidden rounded-3xl bg-zinc-950 ring-1 ring-white/10 p-6 hover-lift group border-gradient"
          >
            <div className="relative z-10">
              <span className="text-xs text-zinc-500 uppercase tracking-widest font-medium">
                Corrective RAG
          ...
          <div
            data-feat-card
            className="min-h-[280px] relative overflow-hidden rounded-3xl bg-zinc-950 ring-1 ring-white/10 p-6 hover-lift group border-gradient"
          >
            <div className="relative z-10">
              <span className="text-xs text-zinc-500 uppercase tracking-widest font-medium">
                Report Engine
          ...
          >
            ...
            <div className="absolute bottom-6 left-6 right-6 space-y-2">
              <div className="anim-comment flex items-center gap-2 bg-zinc-900/80 ring-1 ring-white/5 rounded-xl p-2.5">
                <div className="w-6 h-6 rounded-full bg-blue-500 flex items-center justify-center text-[10px] text-white font-bold shrink-0">
                  A
                </div>
              ...
              <div className="anim-response flex items-center gap-2 bg-zinc-900/80 ring-1 ring-white/5 rounded-xl p-2.5">
                <div className="w-6 h-6 rounded-full bg-emerald-500 flex items-center justify-center text-[10px] text-white font-bold shrink-0">
                  S
                </div>
                <p className="text-[11px] text-zinc-300">
          ...
          >
            ...
            <div className="absolute bottom-6 left-6 right-6 space-y-1.5">
              <div className="anim-hover-1 px-3 py-2 rounded-lg ring-1 ring-white/10 bg-zinc-900/80 text-xs text-zinc-300 flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-blue-400" /> FinTech
                Regulatory Analysis
              </div>
              <div className="anim-hover-2 px-3 py-2 rounded-lg ring-1 ring-white/10 bg-zinc-900/80 text-xs text-zinc-300 flex items-center gap-2">
